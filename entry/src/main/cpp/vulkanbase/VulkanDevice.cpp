...
{	
	...
	*/
	uint32_t VulkanDevice::getMemoryType(uint32_t typeBits, VkMemoryPropertyFlags properties, VkBool32 *memTypeFound) const
	{
		...
		{
            LOGI("Could not find a matching memory type");
			return -1;
		}
	}
	...
	*/
	...
	{
    LOGI("VulkanDevice::getQueueFamilyIndex");
	...
	*/
	...
	{			
        ...
        LOGI("VulkanDevice::createLogicalDevice");
        ...
        LOGI("vkCreateDevice device： &deviceCreateInfo :p %{public}p", &deviceCreateInfo);
        VkResult result = vkCreateDevice(physicalDevice, &deviceCreateInfo, nullptr, &logicalDevice);
        LOGI("vkCreateDevice device： &logicalDevice :p %{public}p", &logicalDevice);
        LOGI("vkCreateDevice device： logicalDevice :p %{public}p", logicalDevice);
	...
	*/
	...
	{
    LOGI("VulkanDevice::copyBuffer 2");
	...
	*/
	...
	{
    LOGI("VulkanDevice::createCommandPool 2");
	...
	*/
	...
	{
    LOGI("VulkanDevice::extensionSupported ");
	...
	*/
	...
	{
    LOGI("VulkanDevice::getSupportedDepthFormat ");
